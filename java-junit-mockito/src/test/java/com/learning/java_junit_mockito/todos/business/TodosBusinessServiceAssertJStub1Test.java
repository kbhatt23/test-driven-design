...
public class TodosBusinessServiceAssertJStub1Test {
	//mocking can be done using stub
	private TodosBusinessService TodosBusinessService ;
	
	@Before
	public void setup() {
		TodosBusinessService = new TodosBusinessService(new ToDoIntegrationServiceStub1() 
	);
	}
	...
	//expected to have exception thrown as user4 is ntot there in stub
	@Test(expected = RuntimeException.class)
	public void testFindSpringTodosFakeUser() {
		TodosBusinessService.findSpringTodos("user4");
	}
